...
// 售卖方式审核 -- 产品
class ShoumaiList extends Component {
                    ...
                    <span>
                        <Button style={{margin: 5}}
                            ...
                            onClick={() => {
                                // 这里判断角色
                                showKechengEdit()
                                canEdit(record.approveStatus != 1)
                                qishuData(record)
                            }}
                        >
                            {
                                record.approveStatus === 1?'审核':'查看'
                            }
                        </Button>
                        <Button type="primary"
            ...
            <div style={{padding: 15}}>
                ...
                <div className="my-horizontal-div" style={{marginTop: 10, alignItems: 'center'}}>
                    ...
                    <div className="my-horizontal-div margin-left10" style={{alignItems: 'center'}}>
                        ...
                        <Select defaultValue={'待产品审核'} style={{width: 200}}
                                onChange={(e) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(ShoumaiList);