...
import Kechenglist from './KechenglistChakan'
import KechengEdit from '../kechengbanbenshenhe/KechengShenhe'

const {Header, Content, Footer} = Layout;

const Option = Select.Option;

class kechengChakan extends Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(kechengChakan);