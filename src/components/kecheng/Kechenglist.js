    ...
    render() {
        ...
        const columns = [{
            ...
            render: (text, record) => {
                ...
                return (
                    <span>
                        {
                            record.status === 0 && record.approveStatus === 0 ?
                                <span>
                                    <Button type="primary"
                                            onClick={() => {
                                                // 这里判断角色
                                    ...
                                    <Button type="primary"
                                            onClick={this.commitShenhe.bind(this, record.courseId)}
                                            style={{margin: 5}}>提交审核</Button>
                                </span> :
                                record.status === 0 && record.approveStatus === 1 ?
                                    ...
                                    record.status === 0 && record.approveStatus === 3 ?
                                        <span>
                                    <Button type="primary"
                                            onClick={() => {
                                                // 这里判断角色
                                    ...
                                    <Button type="primary"
                                        ...
                                        record.status === 1 && record.approveStatus === 2 ?
                                            <span>
                                    <Button type="primary"
                                            onClick={() => {
                                                // 这里判断角色
                                            ...
                                            style={{margin: 5}}>查看</Button>
                                    <Button type="primary"
                                            onClick={this.soldOut.bind(this, record.courseId, 2)}
                                            style={{margin: 5}}>下架</Button>
                                </span> :
                                            record.status === 2 && record.approveStatus === 2 ?
                                                <span>
                                    <Button type="primary"
                                            onClick={() => {
                                                // 这里判断角色
                                            ...
                                            style={{margin: 5}}>查看</Button>
                                    <Button type="primary"
                                            onClick={this.soldOut.bind(this, record.courseId, 1)}
                                            style={{margin: 5}}>上架</Button>
                                </span> : null
                        }
                        <Button type="primary"
        ...
        return (
            <Content style={{backgroundColor: 'white', margin: 0, padding: 15}}>
                ...
                <div className="my-horizontal-div margin-top20 shenhe-div1">
                    ...
                    <div className="margin-left10">
                        ...
                        <div>
                            {
                                levelQrcodeUrl != '' ?
                                    <img className="margin-top10" src={imageUrl(levelQrcodeUrl)}
                                         style={{width: 200,}}/>
                                    : null
                            }
                        </div>
                ...
                <div className="my-horizontal-div margin-top10" style={{marginTop: 20, alignItems: 'center'}}>
                    <div className="my-content-text">课程版本</div>
